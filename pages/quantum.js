          ...
          >
            <div className=" PaddingLeftRight Margins">
              <div className="WhiteBackground  RoundedEdges   PaddingLeftRight">
                ...
                <h6 className="TextFormattingH6">
                  Containers wrap around contents and can be used in different
                  ways.
                </h6>
              ...
              <div className="WhiteBackground  RoundedEdges   Margins PaddingLeftRight">
                ...
                <h6 className="TextFormattingH6">
                  Link styled according to Catho&apos;s Style Guide. Makes it
                  easier to style an anchor tag.
                </h6>
              ...
              <div className="WhiteBackground  RoundedEdges   PaddingLeftRight">
                <div>
                  ...
                  <h6 className="TextFormattingH6">
                    ...
                    space column gap (called a gutter) for controlling the space
                    between them.
                  </h6>
                </div>
          ...
          >
            <div className="PaddingLeftRight ">
              ...
              <div className="Margins  RoundedEdges WhiteBackground PaddingLeftRight">
                ...
                <h6 className="TextFormattingH6">
                  An accordion is a vertical stack of interactive headings used
                  to toggle the display of further information; each item can be
            ...
            <div className="PaddingLeftRight">
              <div className="PaddingTopBotttom   WhiteBackground RoundedEdges Margins">
                ...
                <h6 className="TextFormattingH6  WhiteBackground">
                  ChargeBar shows the level the user is to be able to complete
                  their stats to the maximum.
                </h6>
                <ChargeBar />
              </div>
              <div className="  PaddingTopBotttom  WhiteBackground RoundedEdges Margins">
                ...
                <h6 className="TextFormattingH6">
                  ...
                  range. Chaneging the component&apos;s props, it&apos;s
                  possible to set the minimum and maximum values, format the
                  tooltip and labels, or disable the component itself.
                </h6>
                <RangeSlider />
              </div>
              <div className="  PaddingTopBotttom  WhiteBackground RoundedEdges Margins PaddingLeftRight">
              ...
              <div>
                ...
                <div className="PaddingTopBotttom  WhiteBackground RoundedEdges PaddingLeftRight Margins">
                  <h4 className="TextFormattingH4">Skeleton</h4>
                  <h6 className="TextFormattingH6">
                    The Skeleton is a component that replaces others while they
                    are loading or not ready to render.
                  </h6>
                  <Skeleton />
                </div>
              </div>
            ...
            <div className="PaddingLeftRight">
              ...
              <div className="PaddingTopBotttom  WhiteBackground RoundedEdges Margins">
                ...
                <h6 className="TextFormattingH6">
                  ...
                  front of all content. It is commonly used to provide an
                  important information or ask for some user interaciont.
                </h6>
                <ControlledDialog />
              </div>
              <div className="PaddingTopBotttom  WhiteBackground RoundedEdges Margins">
                ...
                <h6 className="TextFormattingH6">
                  Hamburger component is used for opening mobile menu. You can
                  also pass a aria-label description to inform screen readers
                  that there are new notifications.
                </h6>
                <Hamburger inverted />
              </div>
              <div className="PaddingTopBotttom  WhiteBackground RoundedEdges Margins">
              ...
              <div className="PaddingTopBotttom  WhiteBackground RoundedEdges Margins">
                ...
                <h6 className="TextFormattingH6">
                  ...
                  reconnect to internet (retry). A ControlledSnackBar has
                  control buttons.
                </h6>
                <ControlledSnackBar />
              </div>
        ...
        <Row>
          ...
          >
            <div className="PaddingLeftRight">
              ...
              <div className=" WhiteBackground  RoundedEdges    Margins PaddingLeftRight">
                ...
                <h6 className="TextFormattingH6">
                  Tags are used for items that need to be labeled, categorized,
          ...
          >
            <div className="PaddingLeftRight">
              ...
              <div className=" WhiteBackground  RoundedEdges  InlineBlock  Margins PaddingLeftRight">
                <h4 className="TextFormattingH4">Tooltip</h4>
                <h6 className="TextFormattingH6">
                  Tooltips provide additional information upon hover or focus.
                  They often contain helper text that is contextual to an
                  element.
                </h6>
        ...
        <Row>
          ...
          >
            <div className="PaddingTopBotttom   WhiteBackground RoundedEdges Margins">
              ...
              <h6 className="TextFormattingH6">
                Avatars are used to display a thumbnail of the u ser&apos;s
                profile picture or an user icon if the picture is not defined.
                It can also display a dot to alert that there is some
                notification.
              </h6>
              <Avatar />
            </div>
          ...
          >
            <div className="PaddingLeftRight">
              ...
              <div className="PaddingTopBotttom   WhiteBackground RoundedEdges Margins">
                ...
                <h6 className="TextFormattingH6">
                  Radio group is a list of radio buttons that are used when a
                  list of two or more options are mutually exclusive, meaning
                  the user must select only one option.
                </h6>
                <RadioGroup
          ...
          >
            <div className="PaddingTopBotttom   WhiteBackground RoundedEdges Margins">
              ...
              <h6 className="TextFormattingH6">
                ...
                structured way, some other components like validation adds check
                behavior of the data against a set of criteria before passing it
                along to the server.{' '}
              </h6>
              <Form>
