                  ...
                  <div className=" PaddingLeftRight Margins">
                    <div className="WhiteBackground  RoundedEdges   PaddingLeftRight">
                      <div>
                        ...
                        <h6 className="TextFormattingH6">
                          Rows are wrappers for columns. Each column has
                          horizontal space column gap (called a gutter) for
                    ...
                    <div className="RoundedEdges  ">
                      <div className=" WhiteBackground  RoundedEdges   PaddingLeftRight">
                        ...
                        <h6 className="TextFormattingH6">
                          List is a component with continuous, vertical indexes
                          of texts or icons.
                        </h6>
                        <List>
                        ...
                        <Card.Header>
                          <Card.HeaderText>
                            ...
                            <Card.Description>
                              ...
                              lectus vitae, interdum pharetra est. Etiam sed
                              quam nec nulla lobortis ultrices.
                            </Card.Description>
                          </Card.HeaderText>
                  ...
                  <div className="PaddingLeftRight">
                    ...
                    <div className="  PaddingTopBotttom  WhiteBackground RoundedEdges Margins">
                      ...
                      <h6 className="TextFormattingH6">
                        ...
                        it&apos;s possible to set the minimum and maximum
                        values, format the tooltip and labels, or disable the
                        component itself.
                      </h6>
                      <RangeSlider />
                    </div>
                    <div className="  PaddingTopBotttom  WhiteBackground RoundedEdges Margins PaddingLeftRight">
                      ...
                      <h6 className="TextFormattingH6">
                        Progress bars are used to give the user a feedback on
                        the progress of a process or an action.
                      </h6>
                      <ProgressBar />
                    </div>
                    <div className="  PaddingTopBotttom  WhiteBackground RoundedEdges Margins PaddingLeftRight">
                    ...
                    <div>
                      <div className="PaddingTopBotttom  WhiteBackground RoundedEdges Margins PaddingLeftRight">
                        ...
                        <h6 className="TextFormattingH6">
                          The Stepper component is a visual tool to show
                          progress using logical and numbered steps.
                        </h6>
                        <CircularLoader />
                      </div>
                    ...
                    <div className=" PaddingTopBotttom  WhiteBackground RoundedEdges PaddingLeftRight Margins">
                      ...
                      <h6 className="TextFormattingH6">
                        Add pagination buttons to help splitting up long
                        contents into shorter, easy to understand blocks.
                      </h6>
                ...
                <article>
                  <div className="PaddingLeftRight">
                    ...
                    <div className="PaddingTopBotttom  WhiteBackground RoundedEdges Margins">
                      ...
                      <h6 className="TextFormattingH6">
                        The Segmented control component is a linear set of two
                        or more alternation buttons, with all segments with same
                        width.
                      </h6>
                      <SegmentedControl
                        name="items-text"
                    ...
                    <div className="PaddingTopBotttom  WhiteBackground RoundedEdges Margins">
                      ...
                      <h6 className="TextFormattingH6">
                        Modals inform users about a task and can contain
                        critical information, require decisions, or involve
                        multiple tasks. A ControlledModal contains control
                        buttons, such as &lsquo;Cancel&rsquo; and
                        &lsquo;Delete&rsquo;.
                      </h6>
                      <ControlledModal />
                    </div>
                    <div className="PaddingTopBotttom  WhiteBackground RoundedEdges Margins">
                      ...
                      <h6 className="TextFormattingH6">
                        SnackBars are used to show an alert about the action
                        that have just been made: delete or archive content by
                        accident (undo), resend messages that not been sent for
                        some reason, or try to reconnect to internet (retry). A
                ...
                <article>
                  <div className="PaddingLeftRight">
                    <div className="PaddingTopBotttom   WhiteBackground RoundedEdges Margins">
                      ...
                      <h6 className="TextFormattingH6">
                        Gets values from a single onChange callback prop and
                        apply a single error message to a group of checkboxes.
                      </h6>
                      <CheckboxGroup
                        error="Some error"
                        options={checkBoxMocks}
                      />
                    </div>
                    <div className="PaddingTopBotttom   WhiteBackground RoundedEdges Margins">
                      <h4 className="TextFormattingH4">Radio Group</h4>
                      <h6 className="TextFormattingH6">
                        Radio group is a list of radio buttons that are used
                        when a list of two or more options are mutually
                ...
                <article>
                  <div className="PaddingTopBotttom   WhiteBackground RoundedEdges Margins">
                    ...
                    <h6 className="TextFormattingH6">
                      ...
                      check behavior of the data against a set of criteria
                      before passing it along to the server.{' '}
                    </h6>
                    <Form>
