      ...
      <Container>
        <Row>
          <Col {...colsProps}>
            ...
            <p>
              Here the instructions to collect the payload in Browser and the
              bundle size:
            </p>
        ...
        <Row>
          <Col {...colsProps}>
            <Alert icon="info" skin="primary">
              <span>
                <strong>Important:</strong> this bundle is bigger than
                applications uses. Here, we use all the components that library
                offers, and some duplicated ones. One application do not use 2
                headers or all components. Its only our unit of measurement.
              </span>
            </Alert>
          </Col>
        </Row>
    ...
    <section>
      <Container>
        ...
        <Row>
          <Col {...colsProps}>
            <span>&rarr;</span>
            <Link href="/cathocomponents">
              Collects catho components metrics
            </Link>
          </Col>
        </Row>
        <Row>
